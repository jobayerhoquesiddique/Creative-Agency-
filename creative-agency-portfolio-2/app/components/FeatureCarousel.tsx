...
const features = [
  {
    ...
    description: "Deep knowledge of multiple blockchain protocols and architectures.",
    icon: "⛓️",
  },
  {
    title: "Smart Contract Security",
    description: "Rigorous testing and auditing for bulletproof smart contracts.",
    icon: "🔐",
  },
  {
    title: "NFT Innovation",
    description: "Cutting-edge NFT solutions with unique utility and features.",
    icon: "🖼️",
  },
  {
    title: "DeFi Development",
    description: "Custom decentralized finance protocols and applications.",
    icon: "💰",
  },
  {
    title: "Tokenomics Design",
    description: "Strategic token economics planning for sustainable projects.",
    icon: "📊",
  },
]
